...
const sidebarLinks = [
    ...
    {name:"Room Lists", path: "/owner/room-lists", icon: assets.listIcon},
]

  return (
    <div className='flex flex-col pt-4 lg:w-64 md:w-48 w-16 h-full text-base border-r border-gray-300 transitiona-all duration-300'>
